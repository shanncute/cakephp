...
<?php
	...
	echo $this->Form->input('department_id',array('options'=>$Department));
	echo $this->Form->input('schedulecategory_id',array('options'=>$Schedulecategory));
	echo $this->Form->input('schedulesubcategory_id',array('options'=>$Schedulesubcategory));
	...
	echo $this->Form->input('process_id',array('options'=>$Process));
	echo $this->Form->input('audit_datetime');
	echo $this->Form->input('meetingroom_id',array('options'=>$Meetingroom));
	echo $this->Form->input('reschedule_approval_authority');
	echo $this->Form->input('status',array('options'=>array('Unassigned','Assigned')));
